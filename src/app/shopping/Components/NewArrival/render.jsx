            ...
            <button className={Styles.ScrollLeft} onClick={handelScrollLeft}>&nbsp;&nbsp; &#x276E;&#x276E; &nbsp;&nbsp;&nbsp;&nbsp;</button>
                {Data.data.map((item) => (
                    <div key={item.ID} className={Styles.OneImage}>
                        <Link href={item.Link}><div className={Styles.OneImageLink}><Image className={Styles.Images} src={item.Image} alt={`Image ${item.ID}`} title={item.Title} width={300} height={300} /></div></Link>
