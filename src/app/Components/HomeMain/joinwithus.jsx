    ...
    return(
        ...
        <div className={Styles.JoinWithUS} >
            ...
            <div>
                ...
                <Link href="https://beta.publishers.adsterra.com/referral/aKMU588PJU" target='_blank' ><Image src="https://i.postimg.cc/7LCXcvxp/PNG-250x250-px.png" height={300} width={300} alt=""/></Link>
                <Link href="/" target='_blank' ><Image src="https://i.postimg.cc/cH8RdLW7/unnamed.webp" height={300} width={300} alt=""/></Link>
                <Link href="https://winzo.onelink.me/gu8K/28342d48" target='_blank' ><Image src="https://i.postimg.cc/QMDgj3tv/460x0w.png" height={300} width={300} alt=""/></Link>
            </div>
        </div>
        </>
    )
