...
export default function OurTeam(){
    return(
        ...
        <div className={Styles.OurTeam}>
            <div>
                <div data-aos="fade-up">Meet our amazing Team</div>
                <div data-aos="fade-up">&quot;Our awesome team builds and takes care of websites for you. They make sure your website looks great and works well all the time. You can rely on them to make your online ideas come true.&quot;</div>
            </div>
            <div>
